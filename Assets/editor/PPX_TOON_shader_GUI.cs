...
public class PPX_TOON_shader_GUI : ShaderGUI
{
...
// 
    ...
    MaterialProperty _Use_custom1_to_disslove;
...
#region [变身]
        ...
        if (_use_dissolve.floatValue == 1)
        {
            ...
            _Use_custom1_to_disslove = FindProperty("_Use_custom1_to_disslove", properties);
            materialEditor.ShaderProperty(_Use_custom1_to_disslove, "Use_custom1_to_disslove");
